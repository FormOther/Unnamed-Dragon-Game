...
public class MapEvent {
	...
	private static final int WORLD_DIFFICULTY_MIN = 0;
	private static final int WORLD_DIFFICULTY_MAX = 10;
...
//----------------------------------------------------------
	...
	public void setWorldDifficulty(int difficulty) {
		this.worldDifficulty = Math.min(Math.max(difficulty, WORLD_DIFFICULTY_MIN), WORLD_DIFFICULTY_MAX);
	}
		
	public void incrementWorldDifficulty(int increment) {
		setWorldDifficulty(getWorldDifficulty() + increment);
	}
